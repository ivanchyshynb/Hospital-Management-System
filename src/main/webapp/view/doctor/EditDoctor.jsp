...
<div class="wrapper">
    <div class="form-body">
        ...
        <form method="post" action="doctor">
                ...
                <div class="form-group col-md-6">
                    ...
                    <select name="specialization" class="form-control" id="specialization">
                        <c:forEach var="specialization" items="${listSpecialization}">
                            <option selected hidden value="${doctor.specialization.id}">${doctor.specialization.name}</option>
                ...
                <div class="form-group col-md-6">
                    ...
                    <select name="category" class="form-control" id="category">
                        <c:forEach var="category" items="${listCategory}">
                            <option selected hidden value="${doctor.category.id}">${doctor.category.name}</option>
                ...
                <div class="form-group col-md-6">
                    ...
                    <select name="hospital" class="form-control" id="hospital">
                        <c:forEach var="hospital" items="${listHospital}">
                            <option selected hidden value="${doctor.hospital.id}">${doctor.hospital.name}</option>
                ...
                <div class="form-group col-md-6">
                    ...
                    <select name="department" class="form-control" id="department">
                        <c:forEach var="department" items="${listDepartment}">
                            <option selected hidden value="${doctor.department.id}">${doctor.department.name}</option>
            ...
            <input type="hidden" name="state" value="updateDoctor">
